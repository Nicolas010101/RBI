...
<style>
    ...
    #infos{
        ...
        width: 300px;
        left: 5vw;
        background: rgba(111, 194, 150, 0.7);
        color: black;
        font-size: x-large;
        font-weight: bold;
        text-align: center;
...
<div class="card" id="infos">
    <div class="card-header">
        Recruit the Best Informatician
    </div>
    ...
    <div class="card-body" id="frenchNews" style="font-size: medium;">
        ...
        <p>Plateforme dédiée aux informaticiens (auto-entrepreneurs compris) en recherche d'emploie et aux recruteurs.</p>
